...
document.addEventListener("DOMContentLoaded", function () {
	...
	function hidePreloader() {
		if (!preloader || preloader.classList.contains("preloaded")) return;
...
/* 
	compliance-logo-slider
*/

if($('.fx-compliance-active').length) {
	let slider = new Swiper('.fx-compliance-active', {
		loop: true,
		loopedSlides: 8,
		spaceBetween: 0,
		speed: 4000,
...
*/
(function () {
	const player = document.querySelector('.fx-video-player');
	const video = document.getElementById('fx-home-video');
	if (!player || !video) return;

	const toggleBtn = player.querySelector('.fx-video-player-toggle');
	const muteBtn = player.querySelector('.fx-video-player-mute');
	const fullBtn = player.querySelector('.fx-video-player-fullscreen');
	const bigPlay = player.querySelector('.fx-video-player-bigplay');
	const progress = player.querySelector('.fx-video-player-progress');
	const progressFill = player.querySelector('.fx-video-player-progress-fill');
	const frame = player.querySelector('.fx-video-1');

	const setToggleIcon = function () {
	...
	player.querySelector('.fx-video-player-bar').addEventListener('click', function (e) {
		e.stopPropagation();
	});
